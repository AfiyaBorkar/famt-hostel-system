									...
									<tbody>
										...
										?>
											...
											<tr>
												...
												<td><a href="javascript:void(0);" onClick="popUpWindow('./full-profile.php?id=<?php echo $row->id; ?>');" title="View Full Details">Print Data</a></td>
											</tr>
											<tr>
												<td colspan="4"><b>Reg no. :<?php echo $row->postingDate; ?></b></td>
												<td colspan="4"><b>Building :<?php echo $row->Building; ?></b></td>
											</tr>
