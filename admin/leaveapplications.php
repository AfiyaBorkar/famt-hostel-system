...
<?php	
$aid=$_SESSION['id'];
$ret="select * from registration where leaveapplication !=''";
...
<td><?php echo $row->leaveapplication;?></td>
<td><?php echo $row->leaveapplicationstatus;?></td>
<td>

<a href="edit-student-leaveapplication.php?id=<?php echo $row->id;?>"><i class="fa fa-edit"></i></a>
